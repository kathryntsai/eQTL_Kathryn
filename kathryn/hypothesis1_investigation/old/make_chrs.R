...
# #BSUB -J “myArray[1-22]” myJob
# 
# module load R/3.4.0 #for data.table package
# Rscript make_chrs_TJA.R ${LSB_JOBINDEX} > make_chrs_TJA_${LSB_JOBINDEX}.Rout
