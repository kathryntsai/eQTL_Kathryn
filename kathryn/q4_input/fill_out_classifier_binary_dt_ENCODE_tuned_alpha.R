...
for (chrom in 1:length(chromosomes)){
  ...
  load(paste0(my_path, "q4_input/fullIMPACT_ENCODE_dataset_partitioned_for_chr",chromosomes[chrom],"_datatable.RData"))
...
system(paste0("gzip ", my_path, "q4_output/Classifier_binary_ENCODE_cis_v_trans_eQTLs.txt"))